...
try:
    while True:
        ...
        if jarvis_score > 0.45:
            ...
            # This wipes out the "Hey Jarvis" audio history so it won't loop infinitely.
            model.reset()

            # Run your main voice assistant logic
            trigger_jarvis()

            # Clear out any leftover junk audio that accumulated in the hardware driver buffer
            # while Whisper was running before restarting the stream tracker.
